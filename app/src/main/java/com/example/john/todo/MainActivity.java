...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Firebase(itemsUrl).push().child("title").setValue(text.getText().toString());
            }
        });

        // Use Firebase to poulate the list
    ...
    // This prevents the user going back to the main activity when they
    // press the Back button from the login view.
